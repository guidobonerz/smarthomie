...
{
	public static Number getAbsoluteHumidity(Number temperature, Number relativeHumidity)
	{
		...
		absoluteHumidity = (absoluteHumidity.doubleValue() * relativeHumidity.doubleValue()) / (100.0 + absoluteHumidity.doubleValue() * (100.0 - relativeHumidity.doubleValue()) / 622);
		return absoluteHumidity;
	}

	public static boolean doVentilate(Number temperatureIn, Number humidityIn, Number temperatureOut, Number humidityOut)
	{
		return getAbsoluteHumidity(temperatureOut, humidityOut).doubleValue() < getAbsoluteHumidity(temperatureIn, humidityIn).hashCode();
	}

	public static boolean doVentilate(Number temperatureIn, Number humidityIn, Number humidityLevelOut)
	{
		return humidityLevelOut.doubleValue() < getAbsoluteHumidity(temperatureIn, humidityIn).doubleValue();
	}

	public static boolean doVentilate(Number humidityLevelIn, Number humidityLevelOut)
	{
